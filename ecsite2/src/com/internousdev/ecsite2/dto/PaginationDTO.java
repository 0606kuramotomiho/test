...
public class PaginationDTO {
	...
	private List<ShopInfoDTO> currentShopInfoPage;	// 1ページ分の商品情報
	...
	public List<ShopInfoDTO> getCurrentShopInfoPage() {
		return currentShopInfoPage;
	}
	public void setCurrentShopInfoPage(List<ShopInfoDTO> currentShopInfoPage) {
		this.currentShopInfoPage = currentShopInfoPage;
	}
